        ...
        <div id="list-item-1">
            ...
            <div class="rn-banner-area">
                <div class="game-banner-short-slick-wrapper slick-arrow-style-one rn-slick-dot-style">
                    <a href="https://app.tokiefarm.io/referral" target="_blank"><img src="../assets/images/defi/referral.jpg" ></a>
                    <!-- <a href="https://app.tokiefarm.io/tokie-farms" target="_blank"><img src="../assets/images/defi/farms2.jpg" ></a> -->
